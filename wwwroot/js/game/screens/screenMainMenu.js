/**
 * screenMainMenu.js — Модуль экрана главного меню
 */

import { transition, loadSavedPlayer, Screen } from '../stateManager.js';
import { switchScene } from '../threeScene.js';

// Глобальный API для onclick-атрибутов в HTML
window._spa = window._spa ?? {};
...
window._spa.goto         = (s) => transition(s);
